    ...
    <div className="min-h-screen bg-[var(--bg-primary)]">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <PageTip
          ...
          description="Analytics help you understand what's working and optimize your outreach strategy."
          tips={[
            "Reply rate shows what percentage of leads responded",
            "Meeting rate tracks how many emails led to scheduled calls",
            "Filter by project or time period for detailed insights",
            "Use these insights to improve your templates and sequences",
          ]}
          accentColor="amber"
          icon={
